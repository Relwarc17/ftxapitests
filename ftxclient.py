...
class FtxClient:
    ...
    # This method is to initialize the class and assign the variables that would be used by the class
    ...
    # Executes a get request to the param path
    def _get(self, path: str, params: Optional[Dict[str, Any]] = None) -> Any:
        return self._request('GET', path, params=params)

    # Executes a post request to the param path
    def _post(self, path: str, params: Optional[Dict[str, Any]] = None) -> Any:
        return self._request('POST', path, json=params)

    # Executes a delete request to the param path
    def _delete(self, path: str, params: Optional[Dict[str, Any]] = None) -> Any:
        return self._request('DELETE', path, json=params)

    # Executes the actual requests using python requests library
    # returns the processed response fron the request
    ...
    # This signs the request using the api keys and a nonce so the FTX API allows us to make requests
    ...
    # This wil process the response from the requests and return ajso string with the data of the response or an error
    # if request is not successful or data can not be formatted to json
    ...
    # Call to list all the futures
    def list_futures(self) -> List[dict]:
        return self._get('futures')

    # Call to list all the markets
    def list_markets(self) -> List[dict]:
        return self._get('markets')

    # Call to get info from a single market
    def get_market_info(self, market: str) -> dict:
        return self._get(f'markets/{market}')

    # Call to get orders from a single market
    def get_orderbook(self, market: str, depth: int = None) -> dict:
        return self._get(f'markets/{market}/orderbook', {'depth': depth})

    # Call to get trades from a single market
    def get_trades(self, market: str) -> dict:
        return self._get(f'markets/{market}/trades')

    # Call to get info from an account
    def get_account_info(self) -> dict:
        return self._get(f'account')

    # Call to get open orders from a market
    def get_open_orders(self, market: str = None) -> List[dict]:
        return self._get(f'orders', {'market': market})

    # Call to get order history from a market
